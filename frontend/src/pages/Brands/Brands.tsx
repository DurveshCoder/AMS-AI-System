...
import { Plus, Award, Globe, Pencil, Trash2, X } from 'lucide-react';
...
export default function Brands() {
    ...
    const saveMutation = useMutation({
        ...
        onSuccess: () => { toast.success('Saved!'); queryClient.invalidateQueries({ queryKey: ['brands'] }); setShowForm(false); setEditing(null); },
    ...
    const openEdit = (b: any) => { setEditing(b); setForm({ name: b.name, website: b.website || '', description: b.description || '' }); setShowForm(true); };
    const openNew = () => { setEditing(null); setForm({ name: '', website: '', description: '' }); setShowForm(true); };
